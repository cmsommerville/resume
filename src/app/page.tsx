  ...
  return (
    <main className="container relative mx-auto scroll-my-12 overflow-auto p-4 print:p-6 md:p-16">
      <section className="mx-auto w-full max-w-2xl space-y-8 bg-white print:space-y-6">
        ...
        <Section className="hidden gap-y-2 print:flex">
          <h2 className="text-xl font-bold">Older Highlights</h2>
          {RESUME_DATA.work.map((work) => {
            return (
              <Card
                key={work.company}
              ...
              >
                <CardHeader>
                  <div className="flex items-center justify-between gap-x-2 text-base text-sm">
                    <h3 className="inline-flex items-center justify-center gap-x-1 font-semibold leading-none">
                      <a className="hover:underline" href={work.link}>
                        {work.company}
                      </a>
